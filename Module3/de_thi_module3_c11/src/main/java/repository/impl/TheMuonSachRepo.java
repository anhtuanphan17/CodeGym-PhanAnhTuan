...
public class TheMuonSachRepo implements ITheMuonSachRepo {
...
//
//
    private static final String FIND_ALL_THE_MUON_SACH = "SELECT * FROM the_muon_sach;";
...
//            PreparedStatement preparedStatement = connection.prepareStatement(FIND_ALL_THE_MUON_SACH);
